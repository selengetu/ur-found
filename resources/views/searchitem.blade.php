...
<div class=row>
	...
	<div class="card">
	<form method="POST" action="{{ route('searchitem') }}" enctype="multipart/form-data">
    @csrf
<div class="border border-3 p-4 rounded">
							  ...
							  <label for="inputPrice" class="form-label"><h4>Filter</h4></label>
								<div class="col-md-12">
									...
									<select class="form-select" id="s_category_id" name="s_category_id">
								  ...
								  <div class="col-md-12">
									...
									<select class="form-select" id="s_campus_id" name="s_campus_id">
								  ...
								  <div class="col-md-12">
									...
									<input type="date" class="form-control" id="s_lost_date" name="s_lost_date">
								  </div>
								  <div class="mb-2">
									  <div class="d-grid">
                                         <button type="submit" class="btn btn-primary" style="background:#00205BFF;border:#00205BFF;color:white;">View result</button>
									  </div>
								  </div>
							  </div> 
		 </form>
